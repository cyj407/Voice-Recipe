...
public class ShareFragment extends Fragment {
    ...
    private ImageButton btnCamera, btnShare;
    ...
    public void take_photo() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            imageUri = FileProvider.getUriForFile(getActivity(),"com.llk.study.activity.PhotoActivity",outputImage);
        }else {
        ...
        switch (requestCode) {
            case 1 :
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getContext(),"need Permittion",Toast.LENGTH_SHORT);
                }
                break;
            default:
                break;
